...
class TransferFunctionHelper(object):
    ...
    def plot(self, fn=None, profile_field=None, profile_weight=None, ipython=True):
        ...
        ipython: boolean, optional
                 if true and fn in none, will return ipython image
                 if false and fn is none, will return matplotlib axis
        Returns
        -------
        ...
        return ax
        # print("oh hi")
        # if fn is None and ipython is True:
        ...
        #     img = f.read()
        #     return Image(img)
        # elif fn is None and ipython is False:
        #     print("hello?")
        #     return ax
        # else:
        #     fig.savefig(fn)
