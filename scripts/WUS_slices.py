'''
loads SAW642AN_kmps.nc and plots some global slices of Vs at different depths,
...
#
# # find bounding indeces for each coordinate
# ndx = {}
# for dim in list(bnds.keys()):
#     coord=model.data.variables[dim][:]
#     ndx[dim]=np.where((coord >= bnds[dim][0]) & (coord <= bnds[dim][1]))[0]
