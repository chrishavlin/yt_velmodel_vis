...
if os.path.isfile(dvs_n) and rerun is False:
    dvs=np.load(dvs_n)
    model.coordTransform('sphere2cart')
else:
    model.interp2cartesian(fields=['dvs'],res=[10000,10000,10000], input_units='m',max_dist=25000)
...
sc.save(os.path.join(out_dir,'cartInterpTest.png'))
